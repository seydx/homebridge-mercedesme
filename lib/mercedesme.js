...
const debug = require('debug')('MercedesApi');
  ...
  async _refreshToken() {
    ...
    try {
      ...
      if (shouldRefresh) {
        ...
        const refreshParams = {
          scope: 'mb:vehicle:mbdata:vehiclestatus mb:vehicle:mbdata:fuelstatus mb:vehicle:mbdata:vehiclelock mb:vehicle:mbdata:payasyoudrive offline_access',
        };
